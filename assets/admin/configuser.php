			...
			<?php
				if (isset($_POST['claveOld']) || isset($_POST['claveNew'])){
					...
					$claveNew = $_POST['claveNew'];
						...
						$resultado2 = cambPass ($codigo, $claveOld, $claveNew);
						if ($resultado2 == false){
							echo '<div class="alert alert-warning">';
                            echo '<strong>Ha ocurrido un error!</strong> Revise que su contrase&ntilde;a anterior sea correcta';
                            echo '</div>';
						}else{
							echo '<div class="alert alert-success">';
                            echo '<strong>Muy Bien!</strong> La contrase&ntilde;a ha sido actualizada con &eacute;xito.';
                            echo '</div>';
						}
				}
			?>
            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="configuser.php" method="post">
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" id="pass1" name="claveOld" class="form-control" placeholder="Ingrese su contraseña">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="password_2">Nueva Contraseña</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="password" id="pass2" name="claveNew" class="form-control" placeholder="Ingrese su nueva contraseña">
                                            </div>
                                        </div>
                                    </div>
                                </div>
